...
#define YYNSTATE             6
#define YYNRULE              7
#define YYNRULE_WITH_ACTION  7
#define YYNTOKEN             6
#define YY_MAX_SHIFT         5
#define YY_MIN_SHIFTREDUCE   12
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    22,    3,    4,    1,    2,   20,    5,   23,   18,   27,
 /*    10 */    26,   21,   25,   24,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     0,    1,    2,    3,    4,    6,    7,    8,    5,    8,
 /*    10 */     8,    9,    8,    8,    9,    6,    6,    6,    6,    6,
};
#define YY_SHIFT_COUNT    (5)
#define YY_SHIFT_MIN      (0)
#define YY_SHIFT_MAX      (3)
...
static const YYCODETYPE yyRuleInfoLhs[] = {
     6,  /* (0) program ::= expr */
     7,  /* (1) expr ::= primary_expression */
     7,  /* (2) expr ::= expr SUB primary_expression */
     7,  /* (3) expr ::= expr ADD primary_expression */
     7,  /* (4) expr ::= expr DIV primary_expression */
     7,  /* (5) expr ::= expr MUL primary_expression */
     8,  /* (6) primary_expression ::= INT */
};
...
static const signed char yyRuleInfoNRhs[] = {
   -1,  /* (0) program ::= expr */
   -1,  /* (1) expr ::= primary_expression */
   -3,  /* (2) expr ::= expr SUB primary_expression */
   -3,  /* (3) expr ::= expr ADD primary_expression */
   -3,  /* (4) expr ::= expr DIV primary_expression */
   -3,  /* (5) expr ::= expr MUL primary_expression */
   -1,  /* (6) primary_expression ::= INT */
};
...
#line 29 "parser.yy"
{
    yylhsminor.yy0.int_value = yymsp[0].minor.yy0.int_value;
}
#line 879 "parser.c"
...
#line 32 "parser.yy"
{
    yylhsminor.yy0.int_value = yymsp[-2].minor.yy0.int_value - yymsp[0].minor.yy0.int_value;
}
#line 887 "parser.c"
