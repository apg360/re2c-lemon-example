...
static bool self_on_nothing(quex_ByteLoader*  me, size_t TryN, size_t LoadedN);
...
#endif
    quex_ByteLoader* loader = quex_ByteLoader_POSIX_new(connected_fd);
...
static bool  
self_on_nothing(quex_ByteLoader*  me, size_t TryN, size_t RequiredToLoad)
...
{ 
    ...
    int       retval = getsockopt(((quex_ByteLoader_POSIX*)me)->fd, SOL_SOCKET, SO_ERROR, &error, &len);
