...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    11,    7,    4,    3,    2,    1,    8,    2,    1,    6,
 /*    10 */    19,    5,   18,   10,    9,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     0,    7,    2,    3,    4,    5,    1,    4,    5,    7,
 /*    10 */     9,    7,    8,    7,    7,
};
...
static const char *const yyTokenName[] = { 
  "$",             "OP_INTEGER",    "OP_ADD",        "OP_SUB",      
  "OP_MUL",        "OP_DIV",        "error",         "expr",        
  "in",          
};
#endif /* NDEBUG */
...
#line 25 "parser.y"
{
   printf("in expr(yymsp[0].minor.yy0):\n");
}
#line 663 "parser.c"
        break;
      case 1: /* expr ::= expr OP_ADD expr */
#line 29 "parser.y"
{
    yygotominor.yy0->data.n = yymsp[-2].minor.yy0->data.n + yymsp[0].minor.yy0->data.n;
}
#line 670 "parser.c"
        break;
      case 2: /* expr ::= expr OP_SUB expr */
#line 33 "parser.y"
{
    yygotominor.yy0->data.n = yymsp[-2].minor.yy0->data.n - yymsp[0].minor.yy0->data.n;
}
...
#line 692 "parser.c"
        break;
      case 5: /* expr ::= OP_INTEGER */
#line 45 "parser.y"
{ yygotominor.yy0->data.n = yymsp[0].minor.yy0->data.n; }
#line 697 "parser.c"
        break;
      default:
        break;
