...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    16,   10,    9,    7,    8,    6,   42,    1,    5,   17,
 /*    10 */    33,   11,   10,    9,    7,    8,    6,   40,   40,    5,
 /*    20 */    55,    3,    2,    3,    2,   57,   15,   12,   18,    4,
 /*    30 */    19,    4,   20,   36,   21,   36,   13,    7,    8,    6,
 /*    40 */     5,   14,    5,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */    18,    1,    2,    3,    4,    5,   14,   15,    8,   18,
 /*    10 */    10,   18,    1,    2,    3,    4,    5,   11,   12,    8,
 /*    20 */     0,    1,    2,    1,    2,   16,   17,   18,   18,    9,
 /*    30 */    18,    9,   18,   13,   18,   13,   18,    3,    4,    5,
 /*    40 */     8,   18,    8,   19,   19,   19,   19,   19,   19,   19,
 /*    50 */    19,   19,   19,   19,   19,   14,   14,
};
#define YY_SHIFT_COUNT    (21)
#define YY_SHIFT_MIN      (0)
#define YY_SHIFT_MAX      (34)
static const unsigned char yy_shift_ofst[] = {
 /*     0 */    43,   20,   22,   22,   22,   22,   22,   22,   22,   22,
 /*    10 */    22,    0,   11,   34,   34,    6,   32,   32,   32,   32,
 /*    20 */    32,   32,
};
...
static const YYCODETYPE yyRuleInfoLhs[] = {
    17,  /* (0) expression ::= expr */
    18,  /* (1) expr ::= expr ADD expr */
    18,  /* (2) expr ::= expr SUB expr */
    18,  /* (3) expr ::= expr MUL expr */
    18,  /* (4) expr ::= expr DIV expr */
    18,  /* (5) expr ::= expr MOD expr */
    18,  /* (6) expr ::= expr EXP expr */
    18,  /* (7) expr ::= LPAREN expr RPAREN */
    18,  /* (8) expr ::= ADD expr */
    18,  /* (9) expr ::= SUB expr */
    18,  /* (10) expr ::= INT_LITERAL */
    14,  /* (11) start ::= in */
    15,  /* (12) in ::= */
    15,  /* (13) in ::= in lines */
    16,  /* (14) lines ::= expression END_OF_LINE|END_OF_FILE */
};
...
static const signed char yyRuleInfoNRhs[] = {
   ...
   -1,  /* (11) start ::= in */
    0,  /* (12) in ::= */
   -2,  /* (13) in ::= in lines */
   -2,  /* (14) lines ::= expression END_OF_LINE|END_OF_FILE */
};
...
{ yylhsminor.yy0 = yymsp[0].minor.yy0; }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
      ...
      /* (13) in ::= in lines */ yytestcase(yyruleno==13);
      /* (14) lines ::= expression END_OF_LINE|END_OF_FILE */ yytestcase(yyruleno==14);
        break;
/********** End reduce actions ************************************************/
  };
