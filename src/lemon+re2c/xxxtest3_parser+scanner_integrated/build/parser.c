...
#define ParseTOKENTYPE  union Token 
typedef union {
  int yyinit;
  ParseTOKENTYPE yy0;
  union Token yy3;
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    11,   19,    1,    9,    6,    5,    2,    2,    7,    7,
 /*    10 */     3,    4,    8,    3,   20,   20,   10,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     0,   11,   12,   14,   13,   14,    6,    6,    8,    8,
 /*    10 */     1,   14,    5,    1,   15,   15,    7,
};
...
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    12,   18,   18,   18,   18,   14,   18,   17,   13,   15,
 /*    10 */    16,
};
...
static const char *yyTokenName[] = { 
  ...
  "INT_LITERAL",   "error",         "expression",    "start",       
  "in",            "program",       "expr",        
};
#endif /* NDEBUG */
...
static void yy_reduce(
  ...
  */
      case 3: /* program ::= expr */
{ PARSER_STATE->result_value.number = yymsp[0].minor.yy3.number; }
        break;
      case 4: /* expr ::= expr ADD expr */
{ yygotominor.yy3.number = yymsp[-2].minor.yy3.number + yymsp[0].minor.yy3.number; }
        break;
      case 5: /* expr ::= LPAREN expr RPAREN */
{ yygotominor.yy3.number = yymsp[-1].minor.yy3.number; }
        break;
      case 6: /* expr ::= INT_LITERAL */
{ yygotominor.yy3.number = yymsp[0].minor.yy0.number; }
        break;
      default:
