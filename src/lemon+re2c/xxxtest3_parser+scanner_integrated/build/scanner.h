/* Generated by re2c 2.0.3 on Wed Jan 13 10:57:29 2021 */
...
//Parser START----------------------------------------------------------
    ...
    // A way to access the PARSER_STATE variable
    //
    // must copy paste the struct definition as the one in parser.lemon
    /*
    struct parser_state {
        union tokenvalue result_value;
        bool error;
    };
    // use extern and variable name must be same as the one in parser.lemon
